...
function Viper() {
	...
	this.$injector = providerProvider.$injector;
	...
	this._createRequestInstance = function(factoryAttr) {

		var instance = {};

		var serviceProvider = new ServiceProvider( providerProvider, factoryAttr );
